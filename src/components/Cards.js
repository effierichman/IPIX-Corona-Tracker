...
const Cards = ({
  ...
  return (
    <div className="flex flex-wrap p-4 justify-evenly  ">
      <div className="p-4">
        <div className=" h-72 w-72 max-w-sm border-8 border-red-600 rounded overflow-hidden shadow-lg">
          <div className="px-6 py-4 ">
            ...
            <p className="text-gray-700 text-base">
              {" "}
              Increase in Positives from Previous Day
            </p>
      ...
      {/* <div className="p-4">
        <div className="h-72 w-72 max-w-sm border-8 border-blue-700 rounded overflow-hidden shadow-lg">
          <div className="px-6 py-4 ">
            ...
            <p className="text-gray-700 text-base">
              Increase in Negatives from Previous Day
            </p>
            <p className="text-black-700 text-base">
              <CountUp
                start={0}
      ...
      <div className="p-4">
        <div className="h-72 w-72 max-w-sm border-8 border-black rounded overflow-hidden shadow-lg">
          <div className="px-6 py-4 ">
            ...
            <p className="text-gray-700 text-base">
              Increase in Deaths from Previous Day
            </p>
            <p className="text-black-700 text-base">
              <CountUp
                start={0}
